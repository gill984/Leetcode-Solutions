<h2>333. Largest BST Subtree</h2><h3>Medium</h3><hr><div><p>Given the root of a binary tree, find the largest subtree, which is also&nbsp;a Binary Search Tree (BST), where the largest means subtree has the largest number of nodes.</p>
